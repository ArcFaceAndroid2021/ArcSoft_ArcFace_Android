...
public class DriverListActivity extends Activity {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position == 0) {//单路径
                startActivity(new Intent(com.xiaoyou.face.activity.DriverListActivity.this, SingleRouteCalculateActivity.class));
            } else if (position == 1) {//多路径
                startActivity(new Intent(com.xiaoyou.face.activity.DriverListActivity.this, RestRouteShowActivity.class));
            }
