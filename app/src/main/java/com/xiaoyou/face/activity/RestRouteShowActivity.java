...
import com.xiaoyou.face.activity.search.SearchPoiActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.startpoint:
                Intent sintent = new Intent(com.xiaoyou.face.activity.RestRouteShowActivity.this, SearchPoiActivity.class);
                ...
                break;
            case R.id.endpoint:
                Intent eintent = new Intent(com.xiaoyou.face.activity.RestRouteShowActivity.this, SearchPoiActivity.class);
            ...
            case R.id.selectroute:
                ...
                break;
            case R.id.gpsnavi:
                Intent gpsintent = new Intent(getApplicationContext(), com.xiaoyou.face.activity.RouteNaviActivity.class);
                gpsintent.putExtra("gps", true);
                startActivity(gpsintent);
                break;
            case R.id.emulatornavi:
                Intent intent = new Intent(getApplicationContext(), com.xiaoyou.face.activity.RouteNaviActivity.class);
