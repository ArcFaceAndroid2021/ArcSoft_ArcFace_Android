package com.xiaoyou.face.activity.custom;
...
import com.xiaoyou.face.activity.CustomCarActivity;
import com.xiaoyou.face.activity.CustomDirectionViewActivity;
import com.xiaoyou.face.activity.CustomDriveWayViewActivity;
import com.xiaoyou.face.activity.CustomNextTurnTipViewActivity;
import com.xiaoyou.face.activity.CustomRouteActivity;
import com.xiaoyou.face.activity.CustomRouteTextureInAMapNaviViewActivity;
import com.xiaoyou.face.activity.CustomTrafficButtonViewActivity;
import com.xiaoyou.face.activity.CustomTrafficProgressBarActivity;
import com.xiaoyou.face.activity.CustomZoomButtonViewActivity;
import com.xiaoyou.face.activity.CustomZoomInIntersectionViewActivity;
import com.xiaoyou.face.activity.NorthModeActivity;
import com.xiaoyou.face.activity.OverviewModeActivity;
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position == 0) {//自定义车标
                ...
                startActivity(new Intent(CustomUiActivity.this, com.xiaoyou.face.activity.CustomRouteActivity.class));
            } else if (position == 2) {
                startActivity(new Intent(CustomUiActivity.this, com.xiaoyou.face.activity.CustomRouteTextureInAMapNaviViewActivity.class));
                ...
                startActivity(new Intent(CustomUiActivity.this, com.xiaoyou.face.activity.CustomDirectionViewActivity.class));
                ...
                startActivity(new Intent(CustomUiActivity.this, com.xiaoyou.face.activity.CustomZoomButtonViewActivity.class));
